export default class Scene15 extends Phaser.Scene {
    ...
    create() {
        ...
        if(!this.anims.exists('upwalk')) this.anims.create({ key: 'upwalk',
            frames: [
                { key: 'upwalk_frame1' },
                { key: 'upwalk_frame2' },
                { key: 'upwalk_frame1' },
        ...
        if(!this.anims.exists('leftwalk')) this.anims.create({ key: 'leftwalk',
            frames: [
                { key: 'leftwalk_frame1' },
                { key: 'leftwalk_frame2' }
            ],
        ...
        if(!this.anims.exists('rightwalk')) this.anims.create({ key: 'rightwalk',
            frames: [
        ...
        if(!this.anims.exists('walk')) this.anims.create({ key: 'walk',
            frames: [
                { key: 'player' },
                { key: 'downwalk_frame2' },
                { key: 'downwalk_frame3' }
        ...
        if(!this.anims.exists('stand')) this.anims.create({ key: 'stand',
            frames: [{ key: 'player' }],
            frameRate: 6,
            repeat: -1
        });

        if(!this.anims.exists('monster_upwalk')) this.anims.create({ key: 'monster_upwalk',
            frames: [
        ...
        if(!this.anims.exists('monster_leftwalk')) this.anims.create({ key: 'monster_leftwalk',
            frames: [
        ...
        if(!this.anims.exists('monster_rightwalk')) this.anims.create({ key: 'monster_rightwalk',
            frames: [
        ...
        if(!this.anims.exists('monster_walk')) this.anims.create({ key: 'monster_walk',
            frames: [
        ...
        if(!this.anims.exists('monster_stand')) this.anims.create({ key: 'monster_stand',
    ...
    is_ending_animation() {
        ...
        if (this.trilly) {
            ...
            if (this.trilly.x > this.player.x + 40) {
                ...
                const dialogueBox = this.add.rectangle(400, 300, 700, 200, 0x000000).setOrigin(0.5);
                const dialogueBox_border = this.add.rectangle(400, 300, 680, 180).setStrokeStyle(2, 0xffffff).setOrigin(0.5);
                const dialogue_text = [
                    'oh mio eroe',
                    'sei troppo aura',
