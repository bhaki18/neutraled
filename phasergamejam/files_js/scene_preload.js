export default class ScenePreload extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('npc1', 'phasergamejam/assets/scene2/scene2_secret_character.png');
        ...
        this.load.image('monster_player_upwalking_frame1', 'phasergamejam/assets/scene8/monster_player_upwalking_frame1.png');
        this.load.image('monster_player_upwalking_frame2', 'phasergamejam/assets/scene8/monster_player_upwalking_frame2.png');
        this.load.image('monster_player_upwalking_frame3', 'phasergamejam/assets/scene8/monster_player_upwalking_frame3.png');
        this.load.image('monster_player_downwalking_frame1', 'phasergamejam/assets/scene8/monster_player_downwalking_frame1.png');
        this.load.image('monster_player_downwalking_frame2', 'phasergamejam/assets/scene8/monster_player_downwalking_frame2.png');
        this.load.image('monster_player_downwalking_frame3', 'phasergamejam/assets/scene8/monster_player_downwalking_frame3.png');
        this.load.image('monster_player_rightwalking_frame1', 'phasergamejam/assets/scene8/monster_player_right_frame1.png');
        this.load.image('monster_player_rightwalking_frame2', 'phasergamejam/assets/scene8/monster_player_right_frame2.png');
        this.load.image('monster_player_leftwalking_frame1', 'phasergamejam/assets/scene8/monster_player_left_frame1.png');
        this.load.image('monster_player_leftwalking_frame2', 'phasergamejam/assets/scene8/monster_player_left_frame2.png');

        // Duplicate names to match direct calls in Scene 15:
        this.load.image('monster_player_right_frame1', 'phasergamejam/assets/scene8/monster_player_right_frame1.png');
        this.load.image('monster_player_right_frame2', 'phasergamejam/assets/scene8/monster_player_right_frame2.png');
        this.load.image('monster_player_left_frame1', 'phasergamejam/assets/scene8/monster_player_left_frame1.png');
        this.load.image('monster_player_left_frame2', 'phasergamejam/assets/scene8/monster_player_left_frame2.png');
        ...
        this.load.spritesheet('enemy1', 'phasergamejam/assets/scene5/npc1_animation.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('enemy2', 'phasergamejam/assets/scene5/enemy2_animation.png', { frameWidth: 32, frameHeight: 32 });
        this.load.audio('scene5_audio', 'phasergamejam/assets/sounds/scene5_soundtrack.mp3');
        ...
        this.load.audio('scene6_audio', 'phasergamejam/assets/sounds/scene6_fightsoundtrack.mp3');
        this.load.audio('scene7_audio', 'phasergamejam/assets/sounds/scene7_fightsoundtrack.mp3');
        ...
        this.load.spritesheet('enemy4', 'phasergamejam/assets/scene10/enemy4_animation.png', { frameWidth: 32, frameHeight: 32 });
        ...
        this.load.audio('scene14_audio', 'phasergamejam/assets/sounds/scene14_soundtrack.mp3');
        ...
        this.load.image('tifone_fulmine', 'phasergamejam/assets/scene15/tifone_fulmine.png');
        this.load.image('tifone_laser', 'phasergamejam/assets/scene15/tifone_laser.png');
        this.load.spritesheet('tifone_onde_laterali_frame1', 'phasergamejam/assets/scene15/onde_laterali_animation.png', { frameWidth: 48, frameHeight: 28 });
        this.load.image('tifone_onda_frontale', 'phasergamejam/assets/scene15/tifone_onda_frontale.png');
        this.load.spritesheet('tifone_tornado', 'phasergamejam/assets/scene15/tifone_tornado_animation.png', { frameWidth: 36, frameHeight: 50 });
        this.load.audio('scene15_audio', 'phasergamejam/assets/sounds/scene15_fight_soundtrack.mp3');

        // === OGGETTI AMBIENTALI ===
        this.load.image('Cespuglio', 'phasergamejam/assets/oggetti ambientali/Cespuglio.png');
        this.load.image('ABunchOfFlowers', 'phasergamejam/assets/oggetti ambientali/ABunchOfFlowers.png');
        this.load.image('Teschio', 'phasergamejam/assets/oggetti ambientali/Teschio.png');
        this.load.image('chebellaLANTERNA', 'phasergamejam/assets/oggetti ambientali/chebellaLANTERNA.png');
    }
